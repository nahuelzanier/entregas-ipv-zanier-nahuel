...
func light_the_path():
	if !path_lit:
		...
		if path == 0:
			...
			triggers[Vector2(12,0)] = ["generate_map", $"../Jungle03", Vector2(12,25)]
			triggers[Vector2(13,0)] = ["generate_map", $"../Jungle03", Vector2(13,25)]
			triggers[Vector2(14,0)] = ["generate_map", $"../Jungle03", Vector2(14,25)]
		elif path == 1:
			entities[Vector2(25,11)] = Tags.et_torch_on
			entities[Vector2(25,13)] = Tags.et_torch_on
			triggers[Vector2(26,11)] = ["generate_map", $"../Jungle03", Vector2(1,11)]
			triggers[Vector2(26,12)] = ["generate_map", $"../Jungle03", Vector2(1,12)]
			triggers[Vector2(26,13)] = ["generate_map", $"../Jungle03", Vector2(1,13)]
		elif path == 2:
