...
func _ready():
	...
	map = [
		...
		['xxb','wly','dng','dng','stn','stn','dng','dng','dng','dng','dng','dng','emp','dng','dng','wly','xxx'],
		['xxa','drn','stn','emp','dng','dng','dng','dng','emp','dng','emp','dng','dng','emp','dng','wly','xxx'],
		['xxa','drs','stn','emp','dng','dng','emp','emp','emp','emp','dng','dng','dng','dng','emp','wly','xxx'],
		['xxb','wly','dng','emp','dng','dng','dng','dng','dng','dng','dng','dng','emp','dng','emp','wly','xxx'],
